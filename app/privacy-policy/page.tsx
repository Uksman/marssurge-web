...
export const metadata: Metadata = {
  ...
  description:
    "Read the Marssurge Privacy Policy to understand how we collect, use, and protect your personal information.",
};
...
const sections = [
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content:
          'We automatically collect information about your device, including your mobile device ID (IMEI/UUID), model, manufacturer, operating system version, and IP address. We use this strictly to prevent fraud, detect bot farms, and ensure the "One Person, One Account" policy.',
      },
      {
        heading: "1.3. Derivative Data",
        content:
          "Information our servers automatically collect when you access the App, such as your native actions that are integral to the App, including liking posts, mining sessions, and referral interactions.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content:
          "We may share your information with third parties that perform services for us or on our behalf, including data analysis, email delivery, hosting services, and customer service.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    extra: {
      ...
      footer:
        "Any violation will result in immediate removal of content/accounts and reporting to authorities. To report child safety concerns: email marssurge01@gmail.com",
    },
  },
  {
    id: "deletion",
    ...
    icon: Trash2,
    content:
      "You have the right to request the deletion of your Marssurge account and all associated personal data at any time.",
    extra: {
      ...
      warning:
        "Account deletion is permanent and irreversible. All mined tokens will be lost forever. Your mining progress, referrals, wallet balance, and all account data will be permanently deleted. We cannot recover anything after deletion.",
    },
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
              Marssurge respects the privacy of our users. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your
              information when you visit our mobile application.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto space-y-10">
              ...
              <article
                ...
                {"extra" in section && section.extra && (
                  <div className="mt-6 rounded-xl border border-[#FF6536]/20 bg-[#FF6536]/5 p-5 space-y-3">
                    <h3 className="text-base font-semibold text-[#FF6536]">
                        ...
                        <ul className="space-y-1.5">
                          {section.extra.bullets.map((b: string, i: number) => (
                            <li
                              ...
                              <span className="text-[#FF6536] mt-1">
                                &#8226;
                              </span>
                              <span>{b}</span>
                            </li>
            ...
            <article className="glass-panel p-6 md:p-10 rounded-2xl">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                we will revise the &quot;Last Updated&quot; date at the bottom
